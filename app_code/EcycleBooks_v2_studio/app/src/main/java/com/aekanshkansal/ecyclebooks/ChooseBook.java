...
public class ChooseBook extends Activity {
	...
	class getBooksFromServer extends AsyncTask<String, Void, JSONObject>	{
		...
		private static final String SEARCH_URL="http://ecyclebooks.com/searchbook.php";
		...
		protected void onPostExecute(JSONObject json) {
					...
					if(status.equals("success"))
					{
						try
						{
							...
							for(int i=0;i<bookarr.length();i++)
							{
								...
								b.userId=details.optString("userid");
			...
			{
				Toast.makeText(ChooseBook.this,"Json OBJECT NULL",Toast.LENGTH_LONG);
			}
			...
			lv.setOnItemClickListener(new OnItemClickListener() {
				...
				public void onItemClick(AdapterView<?> parent, View view,
					...
					String bookSelect[]={bm.getUserId(),bm.getBookName(),bm.getBookAuthor(),bm.getBookPublication()};
					Intent nextPage;
