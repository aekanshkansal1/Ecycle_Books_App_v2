...
public class DonateBookActivity extends Activity {
	...
	String name,author,publication,edition;
	EditText bkname,bkauthor,bkpublication,bkedition;
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		...
		donate.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				{
					MyGlobal.showAlert(DonateBookActivity.this,"Notice","Please fill out all fields");
				}
				else if(name.length()>150 || author.length()>150 || publication.length()>150)
				{
					MyGlobal.showAlert(DonateBookActivity.this,"Notice","Please fill fields within 150 character");
				}
				if(edition.isEmpty() || edition.length()>8)
				{
	...
	class DonateBookServer extends AsyncTask<String, Void, JSONObject>	{
		...
		private static final String POST_DONATE_URL="http://ecyclebooks.com/donatebook.php";
		@Override
		protected void onPreExecute() {
			super.onPreExecute();
